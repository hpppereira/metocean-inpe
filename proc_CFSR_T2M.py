...
d['t2m'] = (['time', 'latitude', 'longitude'], mgrid)
...
dset_from_dict.attrs['description'] = 'CFSR 2 m Temperature Monthly Climatology'

dset_from_dict.longitude.attrs['units'] = 'longitude'
dset_from_dict.latitude.attrs['units'] = 'latitude'
dset_from_dict.t2m.attrs['units'] = 'Celsius Deg.'

dset_from_dict.to_netcdf('CFSR_T2M_monthclim_1981_2010.nc')
...
d['longitude'] = ('longitude', np.arange(0,361))
d['t2m'] = (['latitude', 'longitude'], agrid)
...
dset_from_dict.attrs['time_interval'] = '1981 - 2010'
dset_from_dict.attrs['latlon_unit'] = 'Dec. Degrees'
dset_from_dict.attrs['description'] = 'CFSR 2 m Temperature Annual Climatology'

dset_from_dict.longitude.attrs['units'] = 'longitude'
dset_from_dict.latitude.attrs['units'] = 'latitude'
dset_from_dict.t2m.attrs['units'] = 'Celsius Deg.'

dset_from_dict.to_netcdf('CFSR_T2M_annualclim_1981_2010.nc')
