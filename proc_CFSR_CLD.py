...
for arq in list_nc:
    ...
    if cont == 1:
        ...
        dd_concat = xray.concat([dd_concat, dd_aux.cld[:,0,:,:]], dim='time')
...
d['cld'] = (['time', 'latitude', 'longitude'], mgrid)
...
dset_from_dict.attrs['description'] = 'CFSR Total Cloud Monthly Climatology'

dset_from_dict.longitude.attrs['units'] = 'longitude'
dset_from_dict.latitude.attrs['units'] = 'latitude'
dset_from_dict.cld.attrs['units'] = 'percent'

dset_from_dict.to_netcdf('CFSR_CLD_monthclim_1981_2010.nc')
...
d['longitude'] = ('longitude', np.arange(0,361))
d['cld'] = (['latitude', 'longitude'], agrid)
...
dset_from_dict.attrs['time_interval'] = '1981 - 2010'
dset_from_dict.attrs['latlon_unit'] = 'Dec. Degrees'
dset_from_dict.attrs['description'] = 'CFSR Total Cloud Annual Climatology'

dset_from_dict.longitude.attrs['units'] = 'longitude'
dset_from_dict.latitude.attrs['units'] = 'latitude'
dset_from_dict.cld.attrs['units'] = 'percent'

dset_from_dict.to_netcdf('CFSR_CLD_annualclim_1981_2010.nc')
