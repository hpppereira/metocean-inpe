...
d['sphum'] = (['time', 'latitude', 'longitude'], mgrid)
...
dset_from_dict.attrs['description'] = 'CFSR Specific Humidity Monthly Climatology'

dset_from_dict.longitude.attrs['units'] = 'longitude'
dset_from_dict.latitude.attrs['units'] = 'latitude'
dset_from_dict.sphum.attrs['units'] = 'kg/kg'

dset_from_dict.to_netcdf('CFSR_SPHUM_monthclim_1981_2010.nc')
...
d['longitude'] = ('longitude', np.arange(0,361))
d['sphum'] = (['latitude', 'longitude'], agrid)
...
dset_from_dict.attrs['time_interval'] = '1981 - 2010'
dset_from_dict.attrs['latlon_unit'] = 'Dec. Degrees'
dset_from_dict.attrs['description'] = 'CFSR Specific Humidity Annual Climatology'

dset_from_dict.longitude.attrs['units'] = 'longitude'
dset_from_dict.latitude.attrs['units'] = 'latitude'
dset_from_dict.sphum.attrs['units'] = 'kg/kg'

dset_from_dict.to_netcdf('CFSR_SPHUM_annualclim_1981_2010.nc')
