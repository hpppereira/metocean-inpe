% PLEDS na boia Spotter do INPE calculada a partir do
% espectro 1d e direção principal

espe1 = load('/home/hp/Documents/inpe/dados/spotter_antartica/pleds/espe_202002.txt');
espe1 = espe1 * 3;
dire1 = load('/home/hp/Documents/inpe/dados/spotter_antartica/pleds/dire_202002.txt');
mesfig = '202002'
mes = 02;
ano = 2020;
...
axis('off')
%df=f(2)-f(1);
% arq2=[[1 0 0];[1 0 0];[1 0.55 0];[1 0.55 0];[1 1 0];[1  1 0];[0 1 0];[0 1 0]];
...
y=[1;1;12;12]-3.5;
patch(x,y,arq2(1,:));
x=x+2.5;patch(x,y,arq2(2,:));
x=x+2.5;patch(x,y,arq2(3,:));
x=x+2.5;patch(x,y,arq2(4,:));
...
text(1,290,['PLEDS - Spotter/Antártica (INPE/LOA) -- ', mesfig])

%cores das diferentes faixas de periodos
...
for t = length(dire1):-1:1, %era ate 1
...
set(gcf,'paperOrientation','portrait','paperposition',[1 1 18 18],...
     'paperSize',[18 18]);
eval(['print(figure1,''-dpng'',''pleds_spotter_antartica', mesfig ''')']) 
